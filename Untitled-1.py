...
first_student = Student('Dima', 'Eremin', 'Man')
first_student.add_courses('Изучаем Python')
first_student.courses_in_progress += ['Python', 'Git']

second_student = Student('Irina', 'Ivanova', 'Girl')
second_student.add_courses('Изучаем Python')
second_student.courses_in_progress += ['Python', 'Git']

# LECTURERS:

first_lecturer = Lecturer('Fedor', 'Kozlov')
first_lecturer.courses_attached += ['Python', 'Git']

second_lecturer = Lecturer('Elena', 'Lianova')
second_lecturer.courses_attached += ['Python', 'Git']

# REVIEWERS:

first_reviewer = Reviewer('Pavel', 'Vaulin')
first_reviewer.courses_attached += ['Python', 'Git']

second_reviewer = Reviewer('Sonya', 'Ivanova')
